...
class GistsControllerTest < ActionController::TestCase
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post :create, gist: { content: @gist.content, description: @gist.description, private: @gist.private }
    end
  ...
  test "should update gist" do
    patch :update, id: @gist, gist: { content: @gist.content, description: @gist.description, private: @gist.private }
    assert_redirected_to gist_path(assigns(:gist))
  end
